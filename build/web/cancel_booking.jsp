...
<html>
    <head>
        ...
        <form name="ab" action="cancel_booking" method="post">
     ...
     cn=DriverManager.getConnection("jdbc:mysql://localhost:3306/Estore","root","root");
                      ...
                      try
                        {
                          ...
                          String sql="select booking_id from cancel_booking";
        ...
        <div class="div1">
            <br>
            <img src="images/cbooking.png" height="80px" width="90px" style="margin-left:230px">
            <center><h2>Cancel Booking</h2><br><br></center><br>
            <div class="row">
                <div class="col-sm-2"></div>
                <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="Enter booking-ID" name="Bid" value="<%=id%>" onkeypress="javascript : return isNumber(event)">
                </div>
                </div><br>
               ...
               <div class="row">
                ...
                <div class="col-sm-2"></div>
                <div class="col-sm-6">
                <input type="date" class="form-control" placeholder="Enter date" id="date" name="date" onkeypress="javascript : return isNumber(event)"></div>
            </div><br><br>
                ...
                <div class="col-sm-2"></div>
                <div class="col-sm-8">
                <textarea  placeholder="Give your reason...." name="disc" id="dis" onkeypress="javascript : return isAlphanumeric(event)"></textarea>
                </div>
            </div><br><br>
